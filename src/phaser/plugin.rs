...
unsafe extern "C-unwind" fn ext_gui_is_api_supported(
    ...
    crate::phaser::gui::is_api_supported(api, is_floating)
}
...
unsafe extern "C-unwind" fn ext_gui_get_preferred_api(
    ...
    let preferred = crate::phaser::gui::preferred_api();
    unsafe {
...
unsafe extern "C-unwind" fn ext_gui_get_size(
    ...
    unsafe {
        *width = crate::phaser::gui::EDITOR_WIDTH;
        *height = crate::phaser::gui::EDITOR_HEIGHT;
    }
    true
}
...
unsafe extern "C-unwind" fn ext_gui_set_parent(
    ...
    let parent = if api == CLAP_WINDOW_API_X11 {
        #[cfg(unix)]
        {
            crate::phaser::gui::ParentWindowHandle::X11(unsafe { window.clap_window__.x11 })
        }
        #[cfg(not(unix))]
        {
            return false;
        ...
        {
            crate::phaser::gui::ParentWindowHandle::Win32(unsafe { window.clap_window__.win32 })
        }
