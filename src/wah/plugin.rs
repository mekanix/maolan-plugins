...
use maolan_clap::{
    ...
    ffi::{
        ...
        CLAP_EXT_STATE, CLAP_EXT_TAIL, CLAP_INVALID_ID, CLAP_PLUGIN_FEATURE_AUDIO_EFFECT,
        ...
        clap_host, clap_host_params, clap_id, clap_istream, clap_ostream, clap_param_info,
...
use crate::wah::{
    ...
    gui::GuiBridge,
    params::{MODE_LABELS, PARAMS, ParamId, ParamStore, SHAPE_LABELS, sanitize_param_value},
    state::PluginState,
};
...
static FEATURES: SyncFeatureList =
    SyncFeatureList([FEATURE_AUDIO_EFFECT, FEATURE_MONO, FEATURE_STEREO]);
...
unsafe extern "C-unwind" fn ext_gui_is_api_supported(
    ...
    crate::wah::gui::is_api_supported(api, is_floating)
}
...
unsafe extern "C-unwind" fn ext_gui_get_preferred_api(
    ...
    let preferred = crate::wah::gui::preferred_api();
    unsafe {
...
unsafe extern "C-unwind" fn ext_gui_get_size(
    ...
    unsafe {
        *width = crate::wah::gui::EDITOR_WIDTH;
        *height = crate::wah::gui::EDITOR_HEIGHT;
    }
    true
}
...
unsafe extern "C-unwind" fn ext_gui_set_parent(
    ...
    let parent = if api == CLAP_WINDOW_API_X11 {
        ...
        {
            crate::wah::gui::ParentWindowHandle::X11(unsafe { window.clap_window__.x11 })
        }
        ...
        {
            crate::wah::gui::ParentWindowHandle::Win32(unsafe { window.clap_window__.win32 })
        }
        ...
        #[cfg(target_os = "macos")]
        {
            crate::wah::gui::ParentWindowHandle::Cocoa(unsafe { window.clap_window__.cocoa })
        }
